...
[[sections]]
content = """
Once you’ve identified a [change](/what-to-change/overview/) you’d like to try and make at your company, where do you begin?
...
Need inspiration? [Check out](/how-to-change/workers-changing-the-world/) what workers have already achieved."""
template = "block-text"
...
Check if there are existing employee bodies that are working on the issue or related ones: [green teams](https://www.workforclimate.org/post/8-expert-tips-for-creating-a-successful-green-team-at-work), employee resource groups, staff committees, groups or individuals that run volunteer activities or donation activities. Also seek out staff whose jobs directly overlap with what you’re trying to achieve and those with jobs focused on corporate impact. This should improve your awareness of what the company is already doing, its plans, barriers to more ambitious actions, how you can help.
...
[[sections]]
content = """
Try to get this issue on more colleagues’ radars, including more senior decision-makers. Team, department-wide or even company-wide meetings can be suitable venues to raise questions, as can internal online discussion forums.
...
However, if after a reasonable period there are still few signs of progress it may be time to consider going public. Companies are keener than ever to show they are doing well on environmental and social issues to customers and investors; evidence that employees disagree with that assessment can be a powerful catalyst for change. [The Tech Worker Handbook](https://techworkerhandbook.org/media/) gives detailed advice on how to understand the whistleblowing process and how workers can work with the media to bring attention to an issue.
